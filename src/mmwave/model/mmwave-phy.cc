...
void
MmWavePhy::SetMmwaveEnbNetDeviceDeployedList (NetDeviceContainer c)
{
	m_enbNetDevicesList = c;
}

void
MmWavePhy::SetMmwaveUeNetDeviceDeployedList (NetDeviceContainer c)
{
	m_ueNetDevicesList = c;
}

Architecture
MmWavePhy::GetPhyArchitecture ()
{
	return m_phyArchitecture;
}

void
MmWavePhy::SetPhyArchitecture (Architecture arch)
{
	m_phyArchitecture = arch;
}
