...
//	Ptr<MmWaveBeamManagement> mng = CreateObject<MmWaveBeamManagement>();
	...
	Simulator::Schedule(Period,&MmWaveEnbPhy::StartSsBlockSlot,this); //	StartSsBlockSlot();
...
//	antennaArray->ChangeToOmniTx ();
	...
	SlotAllocInfo currSlot;		//This struct contains the slot information for the current subframe
...
//	Simulator::Schedule (slotPeriod, &MmWaveEnbPhy::StartSsBlockSlot, this);
	...
	// Change the beam
//	m_beamManagement->BeamSweepStepTx();
	Simulator::Schedule(Period-NanoSeconds(1), &MmWaveBeamManagement::BeamSweepStepTx,m_beamManagement);
...
{
	// Carlos modification: It is not needed to change the beamforming vector
...
Ptr<MmWaveBeamManagement>
MmWaveEnbPhy::GetBeamManagement ()
{
