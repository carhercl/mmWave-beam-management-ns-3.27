...
//	void SetPhySapUser (MmWavePhySapUser* ptr);
	...
	// Carlos modification
	void SetMmwaveEnbNetDeviceDeployedList (NetDeviceContainer c);	//Pointer to the list of enbNetDevice objects created in the helper
	void SetMmwaveUeNetDeviceDeployedList (NetDeviceContainer c);	//Pointer to the list of ueNetDevice objects created in the helper

	Architecture GetPhyArchitecture ();
	void SetPhyArchitecture (Architecture arch);
...
//	std::list<SfAllocInfo> m_sfAllocInfoList;
	...
	// Carlos modification
	Architecture m_phyArchitecture;

	NetDeviceContainer m_enbNetDevicesList; //Pointer to the list of enbNetDevice in MmWaveHelper (for scanning purposes)
	NetDeviceContainer m_ueNetDevicesList; //Pointer to the list of enbNetDevice in MmWaveHelper (for interference purposes)
	// End of modification
