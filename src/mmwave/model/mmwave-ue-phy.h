...
private:
	...
	//TODO: Consider moving this method to a class outside the PHY
	/*
	 * \brief This method is a port of the AttachToClosestEnb method in MmWaveHelper class, needed to attach the UE to the selected eNB
	 */
	void AttachToSelectedEnb (Ptr<NetDevice> ueDevice, Ptr<NetDevice> enbDevice);
